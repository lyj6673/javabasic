...
//	@param num :1 일요일, 2 월요일... 7 토요일
	...
	public void printWeek(int num) {
		...
		if(num==1)System.out.println("화요일");
		if(num==1)System.out.println("수요일");
		if(num==1)System.out.println("목요일");
		if(num==1)System.out.println("금요일");
		if(num==1)System.out.println("토요일");
